export const SAMPLE_TEXT = `Welcome to SpeedRead. This sample will gradually increase in speed from 200 words per minute all the way up to 900. Just relax and let your eyes focus on the highlighted letter. You do not need to move your eyes at all. The word will come to you.
